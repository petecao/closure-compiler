  ...
  public boolean shouldTraverse(NodeTraversal t, Node n, Node parent) {
    switch (n.getToken()) {
      ...
      case COMPUTED_FIELD_DEF:
        ...
        Node computedName = n.getFirstChild();
        if (NodeUtil.canBeSideEffected(computedName)) {
          t.report(n, TranspilationUtil.CANNOT_CONVERT_YET, "Computed fields with side effects");
          classStack.peek().cannotConvert = true;
          return false;
        }
        if (!n.isStaticMember() && n.getSecondChild() != null) {

...
public final class RewriteClassMembersTest extends CompilerTestCase {
  ...
  @Test
  public void testStaticComputedNoSideEffects() {
    test(
        lines(
            "/** @unrestricted */", //
            "class C {",
    ...
    test(
        lines(
            ...
            "  static [3];",
            "}"),
        lines("class C {}", "C[1] = 2;", "C[2] = 'hi'", "C[3];"));
    ...
    test(
        lines(
            "/** @unrestricted */", //
            "class C {", //
            "  static [true] = function () {return 1;};",
            "  static [1] = () => {return 2;};",
            "  static [2] = (function a() {return 3;})();",
            "  static [3] = (() => {return 4;})();",
            "}"),
        lines(
            "class C {}", //
            "C[true] = function () {return 1;};",
            "C[1] = () => {return 2;};",
            "C[2] = (function a() {return 3;})();",
            "C[3] = (() => {return 4;})();"));
  ...
  public void testInstanceComputedNoSideEffects() {
    ...
    test(
        lines(
            ...
            "  [1] = () => {return 2;};",
            "  [2] = (function a() {return 3;})();",
            "  [3] = (() => {return 4;})();",
            "}"),
        lines(
            "class C {", //
            "  $jscomp$mem$func$name$m1146332801$0() {",
            "    this[true] = function () {return 1;};",
            "    this[1] = () => {return 2;};",
            "    this[2] = (function a() {return 3;})();",
            "    this[3] = (() => {return 4;})();",
            "  }",
            "  constructor() {",
            "    this.$jscomp$mem$func$name$m1146332801$0();",
  ...
  @Test
  public void testInstanceComputedWithConstructor() {
    test(
        lines(
            "/** @unrestricted */", //
            "class C {", //
  ...
  @Test
  public void testPrefilledConstructorNonComputedInstanceField() {
    test(
        lines(
            "let x = 2;", //
            "class C {",
  ...
  @Test
  public void testNonClassDeclarationsStaticPureComputed() {
    test(
        lines(
            "/** @unrestricted */",
            "let c = class {", //
    ...
    test(
        lines(
            ...
            "  static [1] = 1",
            "}"),
        lines("class A {}", "A.c = class {}", "A.c[1] = 1"));
    ...
    test(
        ...
        lines(
            "class A {}", //
            "A[1] = (() => {class $jscomp$class$name$m1146332801$0 {}",
            "$jscomp$class$name$m1146332801$0[1] = 1;",
            "return $jscomp$class$name$m1146332801$0;",
            "})()"));
  ...
  @Test
  public void testNonClassDeclarationsInstancePureComputed() {
    test(
        lines(
            "foo(",
            "/** @unrestricted */",
  ...
  @Test
  public void testPrefilledConstructorComputedInstanceField() {
    test(
        lines(
            "let x = 2;", //
            "/** @unrestricted */", //
  ...
  @Test
  public void testNonClassDeclarationsWithStaticComputedFields() {
    test(
        lines(
            "/** @unrestricted */", //
            "let c = class C {", //
